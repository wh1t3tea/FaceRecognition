...
class MTCNN_Dataset(Dataset):
    def __init__(self, imgs_path: str, labels_path: str, mode: str, subset: None | str = None,
        ...
        """
        Initialize MTCNN dataset. You are able to use original CelebA-Face dataset:
...
def get_dataloader(self, imgs_path: str, labels_path: str, mode: str, num_workers: int = None,
    ...
    """
    if mode != 'detect':
        raise ValueError("Invalid mode. get_dataloader supports only detection mode.")
